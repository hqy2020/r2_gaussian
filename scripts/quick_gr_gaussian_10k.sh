#!/bin/bash
# GR-Gaussian 快速验证 - 10000 iterations
# 启用 Graph Laplacian 正则化
...
echo "========================================"
echo "GR-Gaussian Quick Test - 10k"
echo "========================================"
...
python train.py \
    ...
    --model_path output/2025_11_17_quick_gr_gaussian_10k \
    --iterations 10000 \
...
echo "开始时间: $START_TIME"
echo "结束时间: $END_TIME"
echo "输出目录: output/2025_11_17_quick_gr_gaussian_10k/"
echo "========================================"
